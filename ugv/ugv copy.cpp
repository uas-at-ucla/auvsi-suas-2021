...
if(UGV doesn't receive drop signal from drone)
{
    State 1;
}
if(UGV receives drop signal from drone)
{
    State 2;
}
if(LiDAR sensor reading < 1 foot)
{
    State 3;
}
if(UGV receives from drone via internmediary server info that it's released)
{
    State 4;
}
if(UGV is close to destination)
{
    State 5;
}
